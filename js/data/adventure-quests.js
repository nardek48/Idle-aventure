...
var ADVENTURE_QUESTS = {
  ...
  /* v3.302.0 (W-2) — Désert, acte I étape 2 « Ce qui vit ici a le temps ». Six rencontres
     avec des bêtes SOLITAIRES des Dunes (la nuée est la leçon de l'étape 10). La leçon est le
     Silencieux : au Désert, un ennemi ordinaire sur deux remplace sa charge par un silence ; le
     Guerrier des sables est Blindé. Récompense portée par l'étape d'Histoire. */
  aq_desert_dunes: {
    id: "aq_desert_dunes",
    type: "kill",
    section: "adventure",
    ...
    worldId: "desert",
    adventureIndex: 0,
    enemyFilter: ["scorpion", "sandworm", "sandwarrior"],
    name: "Ce qui tourne autour du camp",
    story: "Le sable bouge sous la toile, la nuit. Ce qui tourne autour du camp ne se presse pas.",
    icon: "./images/Icons/quest_icons/exploration/exploration1.png",
    steps: [
      { id: "kills_dunes", type: "kill", worldId: "desert", target: 6, desc: "Vaincre {target} bêtes des Dunes" }
    ],
    reward: {}
  },
