...
function getAllowedRarities() {
  ...
  // v3.299.0 (W-1c) : « Tour atteinte » (monde 5 déjà atteint) remplace « questline de la Tour terminée »
  var towerReached = !!(game.worldsEverReached && game.worldsEverReached[5]);
  var isCycling = (game.cycleCount || 0) > 0 && towerReached;
